class Tasks < Formula
  ...
  url "https://github.com/marcus/tasks/archive/refs/tags/v1.9.0.tar.gz"
  sha256 "af7539efceae3a01c8cd674fafa770f98d843ff55d07c8e05a5bdcc0f0f63a36"
  license "MIT"
  ...
  def install
    ldflags = [
      "-s",
      "-w",
      "-X github.com/marcus/tasks/internal/buildinfo.Version=v1.9.0",
  ...
  test do
    assert_match "tasks v1.9.0 (homebrew)", shell_output("#{bin}/tasks --version")
    assert_match "tasks-api v1.9.0 (homebrew)", shell_output("#{bin}/tasks-api --version")
    assert_match "tasks-tui v1.9.0 (homebrew)", shell_output("#{bin}/tasks-tui --version")
  end
end
